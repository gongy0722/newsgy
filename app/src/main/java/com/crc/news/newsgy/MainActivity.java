...
public class MainActivity extends Activity {
    ...
    private class MainPage extends PagerAdapter {
        ...
        public MainPage() {
            ...
            iList.add(View.inflate(MainActivity.this,R.layout.tv_page,null));
            iList.add(View.inflate(MainActivity.this,R.layout.find_page,null));
            iList.add(View.inflate(MainActivity.this,R.layout.me_page,null));
        }
